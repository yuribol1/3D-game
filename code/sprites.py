...
class Sprites:
    def __init__(self):
        ...
        self.list_of_objects = [
            ...
            SpriteObject(self.sprite_parameters['sprite_door_v'], (10.5, 5.5)),
            SpriteObject(self.sprite_parameters['sprite_door_v'], (10.5, 9.5)),
            SpriteObject(self.sprite_parameters['sprite_door_v'], (10.5, 13.5)),
            SpriteObject(self.sprite_parameters['sprite_door_v'], (12.5, 5.5)),
            SpriteObject(self.sprite_parameters['sprite_door_v'], (12.5, 9.5)),
            SpriteObject(self.sprite_parameters['sprite_door_v'], (12.5, 13.5)),
            SpriteObject(self.sprite_parameters['sprite_door_h'], (11.5, 3)),
            SpriteObject(self.sprite_parameters['npc_soldier1'], (2.5, 5)),
            SpriteObject(self.sprite_parameters['npc_soldier1'], (5.51, 5.1)),
            SpriteObject(self.sprite_parameters['npc_soldier1'], (6.61, 5.2)),
            SpriteObject(self.sprite_parameters['npc_soldier1'], (7.68, 5.3)),
            SpriteObject(self.sprite_parameters['npc_soldier1'], (8.75, 5.4)),
        ]
